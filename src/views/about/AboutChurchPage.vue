  ...
  <v-container>
    <v-card rounded="0" variant="text">
      ...
      >
        ...
        <v-tab value="Pastors">Пасторы</v-tab>
...
В браке с 1991 года, трое детей, одна внучка.`,
  }, {
    title: 'Татьяна Ступа',
    img: TaSt,
    subtitle: 'Пастор церкви',
...
Закончил ЛТИ им. Ленсовета и СПХУ и Евроазиатскую богословскую семинарию. <br><br>
...
В браке с 1999 года, трое детей: Анна, Екатерина, Глеб, один внук.`,
  }, {
    title: 'Егор Коротаев',
    img: EKo,

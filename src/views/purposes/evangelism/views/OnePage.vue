...
const yourOneText = ref(`Проект «Кто твой один?» служит помощью в личном благовестии и способен сделать Вас эффективнее в достижении людей для Христа. <br><br>
Проект проходит 2 раза в год и длится 3 недели, в которые мы объединяемся для молитвы за спасение наших родных, знакомых и друзей, и верим, что Бог особенно будет действовать в это время.`)

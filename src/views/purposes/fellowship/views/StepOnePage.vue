...
const stepText = ref([
  ...
  Церковь «Миссия Благая Весть» хочет стать для вас местом, где вам будет комфортно как дома. Каждая здоровая семья имеет общие убеждения, цели и обязательства, и за один четырехчасовой семинар мы хотим поделиться с Вами тем, кто мы, во что мы верим и куда мы идём.<br /><br />
